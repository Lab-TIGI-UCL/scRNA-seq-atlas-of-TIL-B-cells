...
Bcell_integrated <- AddModuleScore(object = Bcell_integrated, features = sig, name = "activated_sig")
FeaturePlot(object = Bcell_integrated, 
            features = "activated_sig1", 
            raster = "true", 
            split.by = "cancer_type",
            order = TRUE) & scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu")))
...
Bcell_integrated <- AddModuleScore(object = Bcell_integrated, features = sig, name = "GC_sig")
FeaturePlot(object = Bcell_integrated, 
            features = "GC_sig1", 
            raster = "true", 
            split.by = "cancer_type",
...
Bcell_integrated <- AddModuleScore(object = Bcell_integrated, features = sig, name = "prolif_sig")
FeaturePlot(object = Bcell_integrated, 
            features = "prolif_sig1", 
            raster = "true", 
            split.by = "cancer_type",
            order = TRUE) & scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu")))
