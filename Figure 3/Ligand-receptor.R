...
liana_results %>%
     ...
     chord_freq(source_groups = c("CD8_Tem","CD4/CD8_Tnaive","CD4_Treg","CD8_Teff","CD4/CD8_terminal_Tex","CD8_GZMK_Tex","CD4 Tcm","CD4_Th","CD4/CD8_Tisg","NK_like_T"),
                target_groups = c("Naive B cells", "Activated Memory B cells", "Resting Memory B cells", "IGKC-high Plasma/Plasmablasts", "Conventional Plasma cells", "Stressed Plasma cells", "Atypical Memory B cells", "Transitional/Proliferative 1", "Transitional/Proliferative 2", "MT1X-high Plasma/Plasmablasts"))
dev.off()
