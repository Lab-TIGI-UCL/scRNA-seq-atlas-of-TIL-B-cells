...
Bcell_integrated <- RenameIdents(object = Bcell_integrated, '3' = "Naive B cells", '1' = "Activated B cells", '0' = "Resting Memory B cells", 
                                 '6' = "IGKC-high Plasma/Plasmablasts", '2' = "Conventional Plasma cells", '4' = "Stressed Plasma cells", 
                                 '5' = "Atypical Memory B cells", '7' = "Proliferative", '8' = "GC B cells", 
                                 '9' = "MT1X-high Plasma/Plasmablasts")

levels(Bcell_integrated) <- c("Naive B cells", "Resting Memory B cells", "Atypical Memory B cells", "Activated B cells", "GC B cells", 
                              "Proliferative", "MT1X-high Plasma/Plasmablasts", "IGKC-high Plasma/Plasmablasts", "Conventional Plasma cells", 
                              "Stressed Plasma cells")


features <- c("CD19", "MS4A1", "IL4R", "TCL1A", "FCER2", "FCMR", "SELL", "CD27", "LY86", "BLK", "LTB", "BANK1", "CCR7", "CHMP1B", "NFKBID", 
              "DUSP4", "CD82", "CD86", "ISG15", "CAPG", "ACP5", "COTL1", "IFITM1", "DRAP1", "TNFRSF13B", "LGALS9", "SHFL", "PLSCR1", "MX2", "IFI6", "IFI44L", "CD69", "CD83", "NR4A2", 
              ...
              "CD38", "SDC1", "FOS", "DNAJB1","DUSP1", "ZFAND2A", "HSPA1B", "HSPA1A", "HSPB1", "HSPA6")


#Load Module IDs
Module_IDs <- read.csv("~/Module_IDs_updated.csv", header = TRUE, check.names = FALSE) %>% as.data.frame()
